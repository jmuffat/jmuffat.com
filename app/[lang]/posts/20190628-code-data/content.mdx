...
import imgExcel from './sphere-surface.jpg'
import imgVisualCode from './sphere-visualprogram-2.png'
...
<Image alt="Visual Code" src={imgExcel}/>
...
<Image alt="Visual Code" src={imgVisualCode}/>
