...
import {Simul2} from '../20201126-pots-et-bac/sim2'
...
Si l'on compare avec la page du [plus petit carré contenant n cercles](https://fr.m.wikipedia.org/wiki/Empilement_de_cercles_dans_un_carr%C3%A9), mes méthodes trouvent une bonne
