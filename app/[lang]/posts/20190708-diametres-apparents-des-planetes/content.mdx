...
import imgPlanets from './diametre-apparent.svg'
import imgBigMars from './mars_aussi_grosse_lune.jpg'

<Image src={imgPlanets} alt="diamètres des planètes"/>
...
<Image src={imgBigMars} alt="Mars aussi grosse que la Lune"/>
